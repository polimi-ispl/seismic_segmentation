...
def parse_arguments():
    ...
    parser.add_argument('--atrous', action="store_true", default=False,
                        help='AtrousFNC version')
    ...
    parser.add_argument('--optimizer', type=str, required=False, default='sgd', choices=['adam', 'sgd', 'rmsprop'],
                        help='Optimizer to be used')
    # Segmentation Loss functions
    parser.add_argument('--loss_seg', nargs='+', type=str, required=False,
                        choices=['l2dist', 'l1dist', 'l2norm', 'l1norm', 'tv', 'bce', 'cce',
                                 'dice', 'hinge', 'chinge', 'focal', 'lovasz', 'clovasz', 'ssce', 'bcel'],
    ...
    #         print("Warning: Categorical Crossentropy does not work with separate classes, switching to Binary Crossentropy...")
...
if __name__ == "__main__":
    ...
    # Data generators
    preproc = albu.Resize(1024, 800, always_apply=True) if any([c in args.dataset for c in "67"]) else None
